...
//[img].+						    [     ]   BOLD  WORD  COLON   QUOTE SP  EQAL  /	  ITAL UNDER HEADER						TER  PB  RET MEM SUP OFF COL RED ORG YEL GRN BLU PUR WHT BLK  SZ FAC URL QUO PRE
					    /*C101*/{C102,  C25,  C25, C101,  C101,	  C25,  C25,C25,C101, C25, C25,   C25,	  C25,    C25,	    NT,  NO, C1, YES,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25, C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,},// found [/img
...
//[img=]						    [     ]   BOLD  WORD  COLON   QUOTE SP  EQAL  /	  ITAL UNDER HEADER						TER  PB  RET MEM SUP OFF COL RED ORG YEL GRN BLU PUR WHT BLK  SZ FAC URL QUO PRE
					     /*C103*/{C25,  C25,  C25,	C104, C25,	  C25, C104,C25, C25, C25, C25,  C25,	  C25,	  C25,	    NT,  NO, C1, YES,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25, C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,},// found [img=
						 /*C104*/{C25,  C98,  C25,	C104, C25,	  C25, C104,C25, C25, C25, C25,  C25,	  C25,	  C25,	    NT,  NO, C1, YES,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25, C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,},// found [img=.+
...
//[email].+						    [     ]   BOLD  WORD  COLON   QUOTE SP  EQAL  /	  ITAL UNDER HEADER						TER  PB  RET MEM SUP OFF COL RED ORG YEL GRN BLU PUR WHT BLK  SZ FAC URL QUO PRE
					    /*C109*/{C110,  C25,  C25, C109,  C109,	  C25, C109,C25,C109, C25, C25,   C25,	  C25,    C25,	    NT,  NO, C1, YES,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,C25,},// found [email].+
